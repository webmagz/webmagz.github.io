        ...
        var famobi = {
                ...
                moreGamesLink: function() {
                    ...
                    if(url = this.config.more_games_url) {
                        window.op3n(url, "") || (window.top.location.href = url);
                    } else {
                        return;

                        confirm("redirecting to... " + url) && (window.op3n(url, "") || (window.top.location.href = url)); // handles the link target in production version, depends on user language
                    }
